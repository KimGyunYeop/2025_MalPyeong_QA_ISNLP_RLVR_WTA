...
def main():
    ...
    generate_args = GenerationConfig.from_pretrained(args.model_name, cache_dir=args.cache_dir).to_dict()
    generate_args["max_new_tokens"] = 2048
    generate_args["top_p"] = 0.97
    generate_args["temperature"] = 1.0
    generate_args["do_sample"] = False
    generate_args["num_beams"] = args.num_beams

    save_path = f"test/{args.run_name}"
